...
var chart = (function () {
    ...
    function renderWordCloud(containerId, option) {
    ...
    // 获取关键词
    module.drawWordCloud = function (containerId, content, keywordsNum) {
        $.ajax({
            type: "get",
            url: '../../static/api/keywords.json',
            success: function (data) {
                var option = {"data": data};
                renderWordCloud(containerId, option);
            }
        });
    };
