                    ...
                    <div class="card-body" id="content">
                        <div class="model">
                            ...
                            <el-form :model="editForm" :rules="rules" ref="editForm" label-width="100px">
                                ...
                                <el-form-item class="m_b50" label="同现词" prop="mustWord">
...
<script>
    ...
    import service from '../../vuex/module/focusKeywords.js';
...
//                    ],
        ...
        methods: {
            getfocusKeyword: function () {
                this.editForm = utils.utils.getfocusKeyword();
            },
            submitForm: function (keywords) {
                debugger;
                var self = this;
                service.actions.editUserFocusKeywords(keywords).then(function () {
                    self.result.type = "success";
                    self.result.message = "保存关键词成功！";
                    var config = utils.utils.getfocusKeyword();
                    localStorage.setItem("focusKeywords", config);
                    self.getfocusKeyword();
                }).catch(() => {
