                        ...
                        <div class="model">
                            ...
                            <el-form :model="addForm" ref="addForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="报告接收日期" class="displayIn  m_r form_item">
                                    <el-select v-model="addForm.cronExpression.day" placeholder="请选择(几号)" class="input_item2">
                                        <el-option
...
<script>
    ...
    optionData.push({value: "2L", label: '倒数第二天'});
    optionData.push({value: "3L", label: '倒数第三天'});
    for (var i = 28; i > 0; i--) {
        var node = {};
        node.value = i;
        node.label = i;
